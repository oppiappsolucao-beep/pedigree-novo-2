...
if page == "Visão Geral":
    ...
    st.markdown(
        """
        <div class="live-card" style="min-height: 180px; display: flex; align-items: center; justify-content: center; text-align: center; margin-top: 2rem;">
            <div>
                <div style="font-size: 2.2rem; font-weight: 900; color: #071B49; line-height: 1.1;">
                    Comissão Jullia
                </div>
                <div style="font-size: 1rem; color: #6B7280; margin-top: 0.55rem;">
                    Cálculo será configurado na próxima etapa.
                </div>
            </div>
        </div>
        """,
